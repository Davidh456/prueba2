...
public class Parte02Test {
    ...
    public void setUp() {
        ...
        portal.agregarMaterial(0,l0);
        portal.agregarMaterial(1,l1);
        portal.agregarMaterial(2,l2);
        portal.agregarMaterial(3,l3);
        portal.agregarMaterial(4,l4);
        portal.agregarMaterial(5,l5);
        portal.agregarMaterial(6,l6);
        portal.agregarMaterial(7,l7);
        portal.agregarMaterial(8,l8);
        portal.agregarMaterial(9,l9);
    }
    ...
    public void testListarBibliotecaMergeSort() {
        ...
        System.out.println("Elementos del arreglo: "+tamanio);
        System.out.println("Elementos del arreglo: "+listaOrdenada.toString());        
        System.out.println("Comparaciones realizadas: "+servicioDeOrdenamiento.comparaciones());
        System.out.println("Intercambios realizados: "+servicioDeOrdenamiento.intercambios());
        assertTrue(servicioDeOrdenamiento.comparaciones()+servicioDeOrdenamiento.intercambios()>tamanio);
    }
